     ...
     if (localStorage.getItem('razorpay_payment_id') != undefined) {
         ...
         var payment_references = localStorage.getItem('razorpay_payment_id');
             ...
             if (isValidationPassed == true) {
                 ...
                 $.ajax({
                     url: 'https://localhost:44306/api/SubscriptionPayment',
                     type: 'POST',
                     dataType: 'json',
                     data: jsonData,
...
function saveItem() {
    ...
    if (isValidationPassed == true) {
        ...
        var jsonData = JSON.stringify(requestData);
        $.ajax({
            url: 'https://localhost:44306/api/Customer',
            type: 'POST',
            dataType: 'json',
            data: jsonData,
            contentType: "application/json; charset=utf-8",
...
function editEntry() {
    ...
    $.ajax({
        url: 'https://localhost:44306/api/Customer?mobile_number=' + mobile,
        type: 'GET',
        dataType: 'json',
        contentType: "application/json; charset=utf-8",
        beforeSend: function () {
...
function getLoanProvider() {
    ...
    $.ajax({
        type: "GET",
        dataType: "json",
        url: 'https://localhost:44306/api/LoanProviders?loan_provider_id=0',
        "bProcessing": true,
        "bServerSide": true,
        beforeSend: function () {
        },
...
function saveLoanInfo() {
    ...
    if (isValidationPassed == true) {
        ...
        var jsonData = JSON.stringify(requestData);
        $.ajax({
            url: 'https://localhost:44306/api/LoanInformation',
            type: 'POST',
            dataType: 'json',
            data: jsonData,
            contentType: "application/json; charset=utf-8",
...
function Login() {
    ...
    $.ajax({
        type: "GET",
        dataType: "json",
        url: 'https://localhost:44306/api/CustomerLogin?mobile_number=' + mobile_number +'&password='+password,
        "bProcessing": true,
        "bServerSide": true,
...
function sbscribe(loanIfoId) {
    ...
    $.ajax({
        type: 'GET',
        dataType: 'json',
        url: 'https://localhost:44306/api/LoanInformation?loan_information_id=' + loanIfoId,
        beforeSend: function () {
            // runLoader();
        },
        success: function (result) {
...
function validate() {
    ...
    //alert("ok");
    $.ajax({
        url: 'https://localhost:44306/api/MobileOTP?mobile_number=' + mobile_number,
        type: 'GET',
        dataType: 'json',
        contentType: "application/json; charset=utf-8",
        beforeSend: function () {
